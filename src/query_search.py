...
#       python3 query_search.py --feat_extractor vit_l_32
#       python3 query_search.py --feat_extractor resnet101
#       python3 query_search.py --feat_extractor vit_l_32 --n 5
#       python3 query_search.py --feat_extractor vit_l_32 --k 20
#       python3 query_search.py --feat_extractor vit_l_32 --n 10 --k 12
#
